...
$config = array (
	 ...
	 */
	'secretsalt' => 'g6jbw9qh0f055rgg2xykq7508x3ig7go',
	 ...
	 * syntaxes.
	 */
	#'store.sql.dsn' => 'sqlite:/var/simplesamlsp1/data/store/dstore.sq3',

	/*
	 * The username and password to use when connecting to the database.
	 */
	#'store.sql.username' => 'root',
	#'store.sql.password' => 'thinkcube',
